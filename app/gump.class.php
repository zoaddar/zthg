...
class GUMP
{
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_max_len':
                    ...
                    break;
                case 'validate_or':
                    $resp[] = "The <span class=\"$field_class\">$field</span> field needs to be $param in length";
                    break;
        ...
        foreach ($this->errors as $e) {
            ...
            switch ($e['rule']) {
                ...
                case 'validate_valid_email':
                    ...
                    break;
                case 'validate_or':
                    $resp[$field] = "The $field field needs to be $param in length";
                    break;
                case 'validate_max_len':
    ...
    */
     ...
     * @return mixed
     */
    protected function validate_or($field, $input, $param = null) {
        if (!isset($input[$field])) {
            return;
        }
        ...
        if (function_exists('mb_strlen')) {
            if (mb_strlen($input[$field]) == (int) $param1) {
                return;
            } else if (mb_strlen($input[$field]) == (int) $param2) {
                return;
            }
        } else {
            if (strlen($input[$field]) <= (int) $param1) {
                return;
            } else if (strlen($input[$field]) <= (int) $param2) {
                return;
            }
        }
